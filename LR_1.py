...
def predict_with_model(morph, operator):
...
#qsar_model = YourModel() # we initalize it ahead of time
    ...
    while i < 500:
        ...
        tree.generateMorphs([predict_with_model]) # vcetne predikce a zapsani do dist_to_target
    ...
    run.to_csv(f'From_{molecule}_with_model_LR_1000.csv',sep='\t', index=False)